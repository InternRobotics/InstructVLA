...
parser.add_argument("--task", type=str, default="perform_all", help="task name")
parser.add_argument("--log-dir-root", type=str, default="/mnt/petrelfs/lihao3/EmbodiedMLLM/CogACT/outputs/ditb_8_lr2e-5_b16_fa15_pa0_shuffle_bridge_rt_1/prism-dinosiglip-224px+bridge_rt_1+diffusion+n2+b16+x42--image_aug--image_aug/results", help="log directory")
parser.add_argument("--ckpt-mapping", type=str, default="tmp.pt", help="log directory")
