...
srun --jobid $SLURM_JOBID bash -c 'python -m torch.distributed.run \
 ...
 scripts/train.py \
  --pretrained_checkpoint "/mnt/petrelfs/lihao3/EmbodiedMLLM/CogACT/outputs/ditb_8_lr2e-5_b16_fa15_pa0_shuffle_oxe/prism-dinosiglip-224px+oxe+diffusion+n2+b16+x42--image_aug--image_aug/checkpoints/step-030000-epoch-0-loss=0.0600.pt" \
  ...
  --run_root_dir ./outputs/ditb_8_lr2e-5_b16_fa15_pa0_shuffle_oxe \
