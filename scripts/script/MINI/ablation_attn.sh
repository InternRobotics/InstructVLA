...
srun --jobid $SLURM_JOBID bash -c 'python -m torch.distributed.run \
 ...
 scripts/train_attn_small.py \
  --vla.base_vlm /mnt/petrelfs/yangshuai1/rep/OpenVLA-share/ckpts/prism-qwen25-extra-dinosiglip-224px-0_5b\
  ...
  --run_id ablation_attn_small_16_GPUs_simpler_120M_without_pretrain_encoder \
  --image_aug True \
