...
srun --jobid $SLURM_JOBID bash -c 'python -m torch.distributed.run \
 ...
 scripts/train_eagle_dual.py \
  ...
  --pretrained_checkpoint /mnt/petrelfs/yangshuai1/rep/cogact_with_history/outputs/head_balation/sys12_dual_104_GPU_RT--image_aug/checkpoints/step-054000-epoch-16-loss=0.0255.pt \
  --vla.type prism-qwen25-dinosiglip-224px+0_5b \
  --vla.data_mix bridge_rt_1 \
  --vla.expected_world_size 128 \
  --vla.global_batch_size 1280 \
