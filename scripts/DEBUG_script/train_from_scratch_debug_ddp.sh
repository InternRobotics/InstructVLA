...
CUDA_VISIBLE_DEVICES=2 torchrun --standalone --nnodes 1 --nproc-per-node 1 scripts/train_debug.py \
  ...
  --vla.train_strategy 'DDPStrategy' \
  ...
  --run_id HIS_prism-dinosiglip-224px+bridge_rt_1+diffusion+n2+b16+x42 \
  --image_aug True \
