...
srun --jobid $SLURM_JOBID bash -c 'python -m torch.distributed.run \
 ...
 scripts/train.py \
  --pretrained_checkpoint /mnt/petrelfs/lihao3/EmbodiedMLLM/AAA_MINI_CogACT/CogACTmini_x_DIT_Atten_HisF_MultiF_R_Silence_faster/outputs/3HIS_ditb_8_lr2e-5_b16_fa15_pa0_shuffle_bridge_rt_1/3HIS_Sil_prism-qwen25-dinosiglip-224px+bridge_rt_1+diffusion+n8+b16+x42--image_aug/checkpoints/step-015000-epoch-10-loss=0.0666.pt \
  ...
  --run_root_dir ./outputs/3HIS_ditb_8_lr2e-5_b16_fa15_pa0_shuffle_bridge_rt_1 \
  --run_id 3HIS_Sil_prism-qwen25-dinosiglip-224px+bridge_rt_1+diffusion+n8+b16+x42 \
  --image_aug True \
