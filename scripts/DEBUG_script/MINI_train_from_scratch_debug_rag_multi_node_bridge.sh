...
torchrun --nnodes 2 --master_addr SH-IDC1-10-140-1-90 --master_port 21451 --node_rank 1 --nproc-per-node 8 scripts/train_rag.py \
  ...
  --run_id debug_rag_top_k=8_freeze_bb_from_step-017500_mlp_output_feature \
  --image_aug True \
