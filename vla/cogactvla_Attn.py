...
class ActionTransformer(nn.Module):
    def __init__(self, token_size, past_action_window_size, future_action_window_size, action_dim, num_layers=6, nhead=8, dim_feedforward=None, dropout=0.1):
        ...
        self.embedding = nn.Linear(token_size, token_size)  # Optional embedding layer
        ...
        self.mlp = nn.Sequential(
            nn.Linear(token_size, dim_feedforward),
            nn.ReLU(),
    ...
    def forward(self, past_actions):
        ...
        past_actions = self.embedding(past_actions)  # (batch, seq_len, token_size)
