...
class ActionWorldModel(nn.Module):
    ...
    def forward(self,
        ...
        output = output.reshape(batch_size, self.future_action_window_size + 1, self.action_dim)
        return output
...
class CogACT(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.action_model = ActionWorldModel(token_size,
                                                past_action_window_size,
                                                future_action_window_size,
                                                action_dim)
    ...
    def forward(
        ...
        **kwargs,
        ...
        pred = self.action_model( cognition_features = cognition_features,
                                  pixel_values = pixel_values,
                                  indices_for_now = indices_for_now,
                                   )
    ...
    def predict_action(
        ...
        **kwargs: str
        ...
        # get action chunk
        BS, step, dim = cognition_features.shape
        samples = self.action_model( cognition_features = cognition_features,
                                  pixel_values = pixel_values,
                                  indices_for_now = None,
                                   )
