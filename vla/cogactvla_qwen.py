...
from transformers.models.qwen2_5_vl.modeling_qwen2_5_vl import Qwen2_5_VLDecoderLayer, Qwen2_5_VLVisionBlock, Qwen2_5_VLCausalLMOutputWithPast
...
class CogACT(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.vlm = vlm
        self.vlm.forward = model_forward(self.vlm)
        ...
        for module_keys in ["visual", "model", "lm_head"]:
        ...
        self.vlm.model.transformer_layer_cls = Qwen2_5_VLDecoderLayer
        ...
        **kwargs,
        ...
        with torch.no_grad():
            output_for_past: CausalLMOutputWithPast = self.vlm(
                ...
                image_grid_thw=image_grid_thw[indices_for_past],
        ...
        output_for_now: CausalLMOutputWithPast = self.vlm(
            ...
            image_grid_thw=image_grid_thw[indices_for_now],
    ...
    def get_fsdp_wrapping_policy(self) -> Callable:
        ...
        prismatic_fsdp_wrapping_policy = partial(
            _module_wrap_policy,
            module_classes={LinearProjector, MLPProjector, FusedMLPProjector, Qwen2_5_VLDecoderLayer, Qwen2_5_VLVisionBlock},
        )
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        vlm = Qwen2_5_VLForConditionalGeneration(pretrained_checkpoint)
    ...
    def predict_action(
        ...
        **kwargs: str
        ...
        if using_cfg:
            ...
            uncondition = uncondition.expand(B, self.past_action_window_size+1, -1) #[B, N, D]
...
class RLDSBatchTransform:
    ...
    def __call__(self, rlds_batch: Dict[str, Any]) -> Dict[str, Any]:
        ...
        conversation = [
            ...
            {"role": "user", "content": [{"type": "text", "text": f"What action should the robot take to {lang}?"}]},
...
class PaddedCollatorForActionPrediction:
    ...
    def __call__(self, instances: Sequence[Dict[str, torch.Tensor]]) -> Dict[str, torch.Tensor]:
        ...
        batch_image_grid_thw = [inst["image_grid_thw"] for inst in instances]
        ...
        pixel_values = torch.cat(batch_pixel_values, dim=0).to(self.pixel_values_dtype)
...
def load(
    ...
    llm_backbone_id = '/mnt/petrelfs/yangshuai1/yangshuai1/share_mllm/Qwen2.5-VL-3B-Instruct'
) -> PrismaticVLM:
    ...
    processor = AutoProcessor.from_pretrained(llm_backbone_id)
    llm_backbone = Qwen2_5_VLForConditionalGeneration.from_pretrained(llm_backbone_id)
    ...
    vlm = CogACT(
        ...
        tokenizer = tokenizer,
        processor = processor,
        token_size= llm_backbone.config.hidden_size
    )
