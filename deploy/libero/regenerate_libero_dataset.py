...
Usage:
    python Libero/robot/libero/regenerate_libero_dataset.py \
...
from Libero.robot.libero.libero_utils import (
...
def main(args):
    ...
    metainfo_json_dict = {}
    metainfo_json_out_path = f"./Libero/robot/libero/{args.libero_task_suite}_metainfo.json"
