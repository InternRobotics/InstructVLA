gpu_id=0
policy_model=cogact
ckpt_path=/mnt/hwfile/OpenRobotLab/lihao3/MLLM/store_ckpt_data/ckpt/CogACT/CogACT-Base/checkpoints/CogACT-Base.pt # CogACT/CogACT-Large CogACT/CogACT-Small
