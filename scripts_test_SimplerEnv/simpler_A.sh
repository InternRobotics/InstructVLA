...
ckpt_path="/mnt/petrelfs/yangshuai1/rep/InstructVLA_official/outputs/release_ckpts/instructvla_finetune_v2_xlora_freeze_head_instruction_state--image_aug/checkpoints/step-006000-epoch-01-loss=0.1724_simpler_3.pt"
...
pid5=$!
echo "InstructVLA_2_cogact_drawer_variant_agg-4A1_cogact_pick_coke_can_visual_matching-8: $pid5"
...
pid6=$!
echo "InstructVLA_2_cogact_drawer_visual_matching-12A1_cogact_bridge-4: $pid6"
...
pid7=$!
echo "InstructVLA_2_cogact_pick_coke_can_variant_agg-2A1_cogact_move_near_visual_matching-4A1_cogact_move_near_variant_agg-7: $pid7"
...
pid8=$!
echo "InstructVLA_2_cogact_put_in_drawer_variant_agg-2A1_cogact_put_in_drawer_visual_matching-8: $pid8"
