...
ckpt_path="/mnt/petrelfs/lihao3/EmbodiedMLLM/CogACTx_DIT_Atten_HisF_MultiF_R_Silence/outputs/HIS_Sil_ditb_8_lr2e-5_b16_fa15_pa0_shuffle_bridge_rt_1/HIS_Sil_prism-dinosiglip-224px+bridge_rt_1+diffusion+n8+b16+x42--image_aug/checkpoints/step-020000-epoch-01-loss=0.0653.pt"
